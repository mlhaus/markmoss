const PlayerApp = {
  ...
  initializePlayerEventListeners() {
    ...
    this.player.on("progress", () => {
       const overlaidControl = document.querySelector(".plyr__control.plyr__control--overlaid");
  if (overlaidControl) {
    overlaidControl.classList.add("active");
  }
    });
  ...
  toggleAccordion() {
    const accordion = document.querySelector(".dropdown-according");
